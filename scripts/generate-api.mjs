...
const categories = [
  {
    ...
    title: "Back Hand Mehndi Designs - Pakistani & Indian Style",
    icon: "🤚",
    ...
    subcategories: [
      ...
      { id: "new-back-hand", name: "New", slug: "new-back-hand-mehndi-designs", imageFolder: "back/new" },
    ],
  },
  {
    id: "front-hand",
    ...
    title: "Front Hand Mehndi Designs - Pakistani & Indian Style",
    icon: "✋",
    ...
    subcategories: [
      ...
      { id: "new-front-hand", name: "New", slug: "new-front-hand-mehndi-designs", imageFolder: "front/new front hand" },
    ],
  },
  {
    id: "full-hand",
    ...
    title: "Full Hand Mehndi Designs - Dulhan Style",
    icon: "🖐️",
  ...
  },
  {
    ...
    title: "Finger Mehndi Designs - Pakistani & Indian",
    icon: "💅",
    ...
    subcategories: [
      ...
      { id: "new-finger", name: "New", slug: "new-finger-mehndi-designs", imageFolder: "fingers/new" },
    ],
  },
  {
    id: "arabic",
    ...
    title: "Arabic Mehndi Designs for Pakistan & India",
    icon: "🌙",
    imageFolder: "arabic",
    subcategories: [],
  },
  {
    ...
    title: "Pakistani & Indian Bridal Mehndi Designs",
    icon: "💍",
    imageFolder: "bridal",
    subcategories: [],
  },
  {
    ...
    title: "Kids Cute Mehndi Designs for Eid & Weddings",
    icon: "👶",
    imageFolder: "kids",
    subcategories: [],
  },
  {
    ...
    title: "Leg Mehndi Designs - Pakistani & Indian Brides",
    icon: "👣",
    imageFolder: "leg",
    subcategories: [],
  },
